 ...
 */
public class DatasourcePropertiesLoaderEnvironmentTest {
    ...
    @Test
    public void testLoadEnvironmentSpecificPropertiesFile() {
    ...
    @Test
    public void testFallbackToDefaultWhenEnvironmentFileNotFound() {
    ...
    @Test
    public void testLoadDefaultPropertiesWhenNoEnvironmentSet() {
    ...
    @Test
    public void testEnvironmentValueIsTrimmed() {
    ...
    @Test
    public void testEmptyEnvironmentFallsBackToDefault() {
    ...
    @Test
    public void testEnvironmentSpecificPropertiesWithDataSource() {
        // Set the environment to "test"
        System.setProperty("ojp.environment", "test");
